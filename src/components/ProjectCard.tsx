...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <div ref={cardRef} className={className}>
      ...
      <div className="desktop:rounded-t-[1vw] img dark:border-Dark-grayish-blue border-Light-grayish-blue">
        <img src={img} alt={title} />
      </div>

      <section className="bg-White dark:bg-Black75 h-[200%] flex flex-col items-start justify-start desktop:gap-[0.8vw] gap-[1vw] !w-full desktop:rounded-b-[1.5vw] rounded-b-[2vw] desktop:px-[1vw] px-[1.5vw] desktop:py-[0.8vw] py-[1.5vw]">
        <h1 className="title desktop:leading-[1.55vw] leading-[2.2vw] desktop:tracking-[0.02vw] tracking-[0.08vw] font-bold mediumTxt text-left text-shadow-2xs text-shadow-gray-100 dark:text-Pale-orange">
          {title}
        </h1>
        <h2 className="desc smallBigTxt font-light text-left text-Dark-grayish-blue dark:text-Light-grayish-blue desktop:tracking-[0.06vw] tracking-[0.06vw] desktop:leading-[1.2vw] leading-[2vw] desktop:text-shadow-2xs text-shadow-gray-100">
          {about}
        </h2>
        <div className="w-full flex desktop:gap-[0.8vw]">{tools}</div>
        <h3 className="desktop:mt-[1vw] w-full flex justify-start desktop:gap-[1.5vw] gap-[2vw] montserrat font-semibold smallTxt">
          <a
            href={link}
            target="_blank"
            rel="noopener noreferrer"
            className="shadow-md dark:shadow-none shadow-gray-300 flex items-center justify-center desktop:gap-[0.4vw] gap-[0.5vw] animate-fade-in-up transition-all ease-linear cursor-pointer2 bg-gradient-to-r from-green-300 via-cyan-400 to-green-600 rounded-[0.28vw] tracking-[0.03vw] desktop:w-[5.5vw] w-[8vw]  py-[0.3vw] text-white"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="shadow-md dark:shadow-none shadow-gray-300 flex items-center justify-center desktop:gap-[0.4vw] gap-[0.5vw] cursor-pointer2 dark:bg-Light-grayish-blue tracking-[0.03vw] rounded-[0.28vw] py-[0.3vw] desktop:w-[5.5vw] w-[8vw] dark:text-Black75 text-White bg-Black75"
          >
